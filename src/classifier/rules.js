...
export const GOOGLE_TYPE_TO_SLUG = Object.freeze({
  ...
  'Family entertainment center': 'amusement-park',
  "Children's amusement center": 'amusement-park',
  'Amusement center': 'amusement-park',
  ...
  "Children's party service": 'playground',

  'Amusement machine supplier': 'arcade',
  'Video arcade': 'arcade',
  'Arcade': 'arcade',
  'Game center': 'arcade',
  'Gaming hall': 'arcade',
  ...
  'مدينة ملاهي': 'amusement-park',
  'ملاهي': 'amusement-park',
  'حديقة ترفيهية': 'amusement-park',
  'مدينة ألعاب': 'amusement-park',
  'حديقة مائية': 'water-park',
  'ألعاب مائية': 'water-park',
  'ملعب أطفال': 'playground',
  'منطقة لعب الأطفال': 'playground',
  'منطقة أطفال': 'playground',
  'صالة ألعاب': 'arcade',
  'مركز ألعاب': 'arcade',
  'مدرسة': 'school',
  'جامعة': 'university',
...
export const NAME_KEYWORD_TO_SLUG = Object.freeze({
  ...
  'water park': 'water-park', 'aqua park': 'water-park',
  'playground': 'playground', "children's playground": 'playground',
  'kids area': 'playground', 'play area': 'playground',
  'arcade': 'arcade', 'video arcade': 'arcade',
  'game center': 'arcade', 'bowling': 'arcade',
  'museum': 'tourist-attr',
  'school': 'school',
  ...
  'سينما': 'cinema',
  'جيم': 'gym',
  'ملاهي': 'amusement-park', 'مدينة ملاهي': 'amusement-park',
  'مدينة العاب': 'amusement-park', 'مدينة ألعاب': 'amusement-park',
  'حديقة مائية': 'water-park',
  'ملعب أطفال': 'playground', 'ملاعب أطفال': 'playground',
  'متحف': 'tourist-attr',
  'مدرسة': 'school',
  'جامعة': 'university',
  'شرطة': 'police',
